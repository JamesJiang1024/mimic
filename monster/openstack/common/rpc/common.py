...
from monster.openstack.common.gettextutils import _
from monster.openstack.common import importutils
from monster.openstack.common import jsonutils
from monster.openstack.common import local
...
The current message format (version 2.0) is very simple.  It is:
    ...
    {
        'monster.version': <RPC Envelope Version as a String>,
        'monster.message': <Application Message Payload, JSON encoded>
    }
...
_VERSION_KEY = 'monster.version'
_MESSAGE_KEY = 'monster.message'
