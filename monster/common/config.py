...
core_opts = [
    cfg.StrOpt('state_path',
               default='/var/lib/monster',
               help='Top-level directory for maintaining monster'),
    ...
    cfg.StrOpt('api_listen',
               default='127.0.0.1',
               help='IP address for monster API to listen.'),
    cfg.IntOpt('api_listen_port',
               default=9001,
               help='Port for monster API to listen.'),
