...
* Call set_defaults with the minimal of the following kwargs:
  ...
  Example:
    ...
    session.set_defaults(
        sql_connection="sqlite:///var/lib/mimic/sqlite.db",
        sqlite_db="/var/lib/mimic/sqlite.db")
...
from mimic.openstack.common.db import exception
from mimic.openstack.common.gettextutils import _  # noqa
from mimic.openstack.common import log as logging
from mimic.openstack.common import timeutils

sqlite_db_opts = [
    cfg.StrOpt('sqlite_db',
               default='mimic.sqlite',
    ...
    def _do_query(self, q):
        ...
        for file, line, method, function in traceback.extract_stack():
            ...
            if file.endswith('db/api.py'):
                continue
            # only trace inside mimic
            index = file.rfind('mimic')
            if index == -1:
                continue
