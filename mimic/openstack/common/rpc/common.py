...
The current message format (version 2.0) is very simple.  It is:
    ...
    {
        'mimic.version': <RPC Envelope Version as a String>,
        'mimic.message': <Application Message Payload, JSON encoded>
    }
...
_VERSION_KEY = 'mimic.version'
_MESSAGE_KEY = 'mimic.message'
