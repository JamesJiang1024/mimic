...
from mimic.common import paths
from mimic.db import migration
from mimic.openstack.common.db.sqlalchemy import session
from mimic.openstack.common import log as logging
from mimic.tests import conf_fixture
...
CONF.import_opt('connection',
                ...
                group='database')
CONF.import_opt('sqlite_db', 'mimic.openstack.common.db.sqlalchemy.session')
